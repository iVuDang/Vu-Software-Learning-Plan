...
| 1        | Python :arrow_forward: | 1. 158 - Python (2nd Edition)_ Learn Pyt - LCF Publishing :white_check_mark: | Scientific Computing with Python (Variables, loops, conditionals, functions, data structures, networking, relational databases, data visualization) :white_check_mark: | Harvard CS50's Introduction to Computer Science :hourglass: | Foundations :white_check_mark: | Spring 2023
...
| 4        | C++ | 4. 505 - automate-the-boring-stuff-with-python-2015 | Relational Databases (Bash, PostgreSQL, Git) :hourglass: | ----- | ----- | Summer 2024
...
| 7        | ----- | ----- | Front End Development Libraries (React, Redux, Sass, Bootstrap, jQuery) :hourglass: | ----- | ----- | ----- |
