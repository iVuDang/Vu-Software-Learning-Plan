...
| 1        | Python :hourglass: | 1. 158 - Python (2nd Edition)_ Learn Pyt - LCF Publishing :white_check_mark: | Scientific Computing with Python (Variables, loops, conditionals, functions, data structures, networking, relational databases, data visualization) :white_check_mark: | Harvard CS50's Introduction to Computer Science :hourglass: | Foundations :white_check_mark: | Spring 2023
...
| 7        | ----- | 7. https://runestone.academy/ns/books/published/cpp4python/index.html  :arrow_forward: | Front End Development Libraries (React, Redux, Sass, Bootstrap, jQuery) :hourglass: | ----- | ----- | ----- |
