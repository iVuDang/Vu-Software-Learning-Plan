...
| 1        | Python :hourglass: | 1. 158 - Python (2nd Edition)_ Learn Pyt - LCF Publishing :white_check_mark: | Scientific Computing with Python (Variables, loops, conditionals, functions, data structures, networking, relational databases, data visualization) :white_check_mark: | Harvard CS50's Introduction to Computer Science :arrow_forward: | Foundations :white_check_mark: | Spring 2023
...
| 3        | SQL :hourglass: | ----- | Machine Learning with Python (TensorFlow, neural networks, natural language processing, reinforcement learning) :hourglass: | Harvard CS50's Web Programming with Python and JavaScript | ----- | Spring 2024
