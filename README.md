...
| 5        | Java | 5. [C++ for Python Programmers](https://runestone.academy/ns/books/published/cpp4python/index.html)  :white_check_mark: | Responsive Web Design (HTML, CSS, Flexbox, CSS Grid) :white_check_mark: | ----- | ----- | ----- |
