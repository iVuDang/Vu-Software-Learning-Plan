...
| 1 | Python :recycle: | 1. 158 - Python (2nd Edition)_ Learn Pyt - LCF Publishing :white_check_mark: | Relational Databases (Bash, PostgreSQL, Git) | CS50's Introduction to Computer Science :arrow_forward: |
| 2 | SQL | 2. 191 - Python Programming for Beginner - Jason Cannon | Scientific Computing with Python (Variables, loops, conditionals, functions, data structures, networking, relational databases, data visualization) | Introduction to Computer Science and Programming Using Python |
